...
def grocery_product_validation(query):

    result = grocery_product_validator_chain.invoke(
        {
            "user_request": query,
...
def grocery_product_generation(query):

    result = grocery_product_generator_chain.invoke(
        {
            "user_request": query,
