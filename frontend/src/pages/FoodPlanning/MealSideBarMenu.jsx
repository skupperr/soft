        ...
        <div className="layout-content-container flex flex-col">
            <div className="flex h-full min-h-[700px] flex-col justify-between bg-white p-4">
                <div className="flex flex-col gap-4">
                    {/* <h1 className="text-[#111418] text-base font-medium leading-normal">Menu</h1> */}
                    <div className="flex flex-col gap-2">
                        {/* <div className="flex items-center gap-3 px-3 py-2">
                            <div className="text-[#111418]" data-icon="ChatCircleDots" data-size="24px" data-weight="regular">
                            ...
                            <p className="text-[#111418] text-sm font-medium leading-normal">Meal Plan Chatbot</p>
                        </div> */}
                        <div className="flex items-center gap-3 px-3 py-2">
                            ...
                            <Link to="/meal-plan/grocery-list" className="flex items-center gap-3 px-3 py-2">
                            <p className="text-[#111418] text-sm font-medium leading-normal">Grocery List</p></Link>
                        </div>
                        <div className="flex items-center gap-3 px-3 py-2 rounded-xl bg-[#f0f2f4]">
                            ...
                            <Link to="/meal-plan" className="flex items-center gap-3 px-3 py-2">
                            <p className="text-[#111418] text-sm font-medium leading-normal">Meal Plan</p></Link>
                        </div>
                        {/* <div className="flex items-center gap-3 px-3 py-2">
